<div class="hidden lg:p-20" id="create-story" uk-modal="">
    <div
        ...
        <div class="space-y-5 mt-7">
            <form action="{{ route('create_story') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div>
                    <label for="" class="text-base">What do you have in mind?</label>
                    <input type="text" name="description" class="w-full mt-3"
                ...
                <div>
                    <div
                        ...
                        <label for="createStatusUrl"
                            ...
                            <input id="createStatusUrl" type="file" name="image" class="hidden" />
