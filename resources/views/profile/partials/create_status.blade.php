        ...
        <form action="{{ route('create_post') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="space-y-5 mt-3 p-2">
                <textarea
                    ...
                    name="description" id="" rows="6" placeholder="What do you have in mind?"></textarea>
            </div>
            ...
            <div class="flex items-center gap-2 text-sm py-2 px-4 font-medium flex-wrap">
                ...
                <div  class="flex items-center gap-1.5 bg-sky-50 text-sky-600 rounded-full py-1 px-2 border-2 border-sky-100 dark:bg-sky-950 dark:border-sky-900">
                    <ion-icon name="image" class="text-base" ></ion-icon>
