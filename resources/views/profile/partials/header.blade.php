                    ...
                    <div  class="hidden bg-white rounded-lg drop-shadow-xl dark:bg-slate-700 w-64 border2"
                        ...
                        <a href="{{route("home")}}">
                            ...
                            <div class="p-4 py-5 flex items-center gap-4">
                                ...
                                <div class="flex-1">
                                    <h4 class="text-sm font-medium text-black">{{$user->first_name}} {{$user->last_name}}</h4>
                                    <div class="text-sm mt-1 text-blue-600 font-light dark:text-white/70">{{$user->user_name}}   </div>
                                </div>
                            </div>
                        ...
                        <nav class="p-2 text-sm text-black font-normal dark:text-white">
                            ...
                            <form action="{{ route('logout') }}" method="post">
                                @csrf
                                @method('POST')
                                <button type="submit" class="flex items-center gap-2.5 hover:bg-secondary p-2 px-2.5 rounded-md dark:hover:bg-white/10">
